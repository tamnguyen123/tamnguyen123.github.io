...
<hr/>
	<div class="container">
		<form class="form-horizontal col-md-8 col-md-offset-3" action="home"
			method="get">
		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center"><%=new SimpleDateFormat("dd/MM/yyyy").format(student.getBirthDate())%></td>
		...
		<hr/>
		<h1 class="text-center">Insert Student</h1>
		<div class="row">
