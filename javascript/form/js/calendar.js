...
function createCalendar() {
    document.write("<table id='calendar' style='display:none; border:1px solid #000;width:242px; padding:0 auto;'>");
    menuOfCalendar();
    insertNameOfDay();
...
function showCalendar() {
    ...
    //document.getElementById("date").style.margin='0px 0px 200px 0px';
}
