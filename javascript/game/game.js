...
// Create Image background in game
...
var render = function() {
	...
	if(!run && end) {
		...
		context.fillText("GAME OVER", 70, 260);
		//draw new highscore
		if(score > highscore) {
			highscore = score;
			...
			context.fillText("NEW HIGH SCORE: " + highscore, 70, 295);
		}
	}
}
...
/*
* Update sprite 
* sprite: name sprite (eg: sprite1, sprite2.....)
*/
...
/*
* Get position when sprites died save in array
*/
...
/*
* Draw image blood in positions sprite died
*/
...
/*
* Restart game when click button reset
*/
function restart() {
	speed = 1;
	score = 0;
